...
export async function POST(request: Request, { params }: Params) {
  ...
  try {
    const response = await fetch(backendUrl(`/api/v1/onboarding/client/tasks/${taskId}/files/complete`), {
      method: "POST",
    ...
    return backendServiceUnavailableResponse("Client onboarding upload confirmation service")
  }
}
