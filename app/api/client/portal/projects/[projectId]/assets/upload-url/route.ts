...
export async function POST(request: Request, { params }: Params) {
  ...
  try {
    const response = await fetch(backendUrl(`/api/v1/client-portal/client/projects/${projectId}/assets/upload-url`), {
      method: "POST",
    ...
    return backendServiceUnavailableResponse("Client project upload preparation service")
  }
}
