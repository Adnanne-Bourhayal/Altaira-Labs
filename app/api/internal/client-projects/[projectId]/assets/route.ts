...
export async function GET(_request: Request, { params }: Params) {
  ...
  try {
    const response = await fetch(backendUrl(`/api/v1/client-portal/admin/projects/${projectId}/assets`), {
    ...
    return backendServiceUnavailableResponse("Admin project asset service")
  }
}
