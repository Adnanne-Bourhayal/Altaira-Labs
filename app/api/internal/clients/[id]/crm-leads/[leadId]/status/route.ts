...
export async function PATCH(request: Request, context: RouteContext) {
  ...
  try {
    const response = await fetch(backendUrl(`/api/v1/client-crm/admin/clients/${id}/leads/${leadId}/status`), {
      method: "PATCH",
    ...
    return backendServiceUnavailableResponse("Client CRM admin status service")
  }
}
