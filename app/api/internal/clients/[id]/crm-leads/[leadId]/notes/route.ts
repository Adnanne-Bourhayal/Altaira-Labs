...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    const response = await fetch(backendUrl(`/api/v1/client-crm/admin/clients/${id}/leads/${leadId}/notes`), {
      method: "POST",
    ...
    return backendServiceUnavailableResponse("Client CRM admin note service")
  }
}
