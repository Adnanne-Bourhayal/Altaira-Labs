...
export async function GET(_request: Request, { params }: Params) {
  ...
  try {
    const response = await fetch(backendUrl(`/api/v1/onboarding/admin/files/${fileId}/download`), {
    ...
    return backendServiceUnavailableResponse("Admin onboarding file service")
  }
}
