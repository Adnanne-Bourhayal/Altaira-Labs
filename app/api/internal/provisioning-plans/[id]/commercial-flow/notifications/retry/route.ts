...
export async function POST(_: Request, context: RouteContext) {
  ...
  try {
    const response = await fetch(backendUrl(`/api/v1/provisioning-plans/${id}/commercial-flow/notifications/retry`), {
    ...
    return backendServiceUnavailableResponse("Commercial email retry service")
  }
}
