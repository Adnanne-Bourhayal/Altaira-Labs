...
export async function POST(_: Request, context: RouteContext) {
  ...
  try {
    const response = await fetch(backendUrl(`/api/v1/provisioning-plans/${id}/commercial-flow/retry`), {
    ...
    return backendServiceUnavailableResponse("Commercial activation service")
  }
}
